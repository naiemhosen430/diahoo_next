    ...
    return (
        <div className='text-center'>
            {coverImage && (
                ...
                <img className='block w-full h-32 bg-slate-700' src={coverImage} alt="no image" />
                </div>
            )}
            <div className='profileImage flex items-center justify-center'>
                <img className='h-20 w-20 block bg-slate-500 rounded-full' src={profileImage} alt="no image" />
            </div>
